...
public extension Publishers {
  struct WithLatestFrom<Upstream, AnotherUpstream, FinalOutput>: Publisher where Upstream: Publisher, AnotherUpstream: Publisher, Upstream.Failure == AnotherUpstream.Failure {
    ...
    init(upstream: Upstream, anotherUpstream: AnotherUpstream, resultSelector: @escaping (Upstream.Output, AnotherUpstream.Output) -> FinalOutput) {
      self.upstream = upstream
      self.anotherUpstream = anotherUpstream
